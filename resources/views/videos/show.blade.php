                ...
                <div class="flex items-center">
                    <div class="w-full mb-0 md:w-auto md:mb-0 md:mr-1">
                        <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(url()->current()) }}"
                            target="_blank"
                            class="px-2 py-1 text-xs text-white bg-blue-500 rounded-lg shadow-md hover:bg-blue-600">Share on
                            Facebook</a>
                    </div>
               
                @livewire('videos.like', ['video' => $video])

<svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 mr-2 text-blue-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
