<footer class="relative py-12 bg-black">
    ...
    <div class="container relative px-4 mx-auto">
        ...
        <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
            <!-- Brand Section -->
            <div class="space-y-4">
                <h3 class="text-xl font-bold tracking-wider text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-600">
                    Click Music
                </h3>
            ...
            <div class="space-y-4">
                ...
                <div class="flex space-x-4">
                    <a href="https://instagram.com/clickmusic1" 
                       target="_blank" 
                    ...
                    <a href="https://www.facebook.com/clickmusicromania" 
                       target="_blank"
                       rel="noopener noreferrer"
                       class="p-2 text-gray-400 transition-all duration-300 border border-gray-800 rounded-lg hover:border-blue-500 hover:text-blue-400 hover:scale-110">
                        <svg xmlns="http://www.w3.org/2000/svg" width="1.5rem" height="1.5rem" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <a href="https://open.spotify.com/artist/0rbyxJSUfSXjmeW652c41O" 
                       target="_blank"
                       rel="noopener noreferrer"
                       class="p-2 text-gray-400 transition-all duration-300 border border-gray-800 rounded-lg hover:border-blue-500 hover:text-blue-400 hover:scale-110">
                        <svg xmlns="http://www.w3.org/2000/svg" width="1.5rem" height="1.5rem" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <a href="https://youtube.com/clickmusicromania" 
                       target="_blank"
                       rel="noopener noreferrer"
                       class="p-2 text-gray-400 transition-all duration-300 border border-gray-800 rounded-lg hover:border-blue-500 hover:text-blue-400 hover:scale-110">
                        <svg xmlns="http://www.w3.org/2000/svg" width="1.5rem" height="1.5rem" fill="currentColor" viewBox="0 0 16 16">
