...
<body class="px-2 bg-gray-200">
    ...
    {{-- Notificare in database --}}

    <div x-data="{ open: false }" class="max-w-md p-2 mx-auto mt-8 bg-white rounded-md shadow-md">
    ...
    <div x-data="{ open: false }" class="max-w-md p-2 mx-auto mt-8 bg-white rounded-md shadow-md">
        <button @click="open = !open">
            <div class="flex justify-between">
                <h2 class="text-xl font-semibold text-center text-black">Trimite e-mail - "Videoclip nou"
                </h2>
                <span x-show="!open" class="pb-2 ml-2 text-2xl font-semibold text-blue-500">+</span>
                <span x-show="open" class="pb-2 ml-2 text-2xl font-semibold text-blue-500">-</span>
            </div>
    ...
    {{-- Adaugare Videoclipuri --}}
    <section x-data="{ open: false }" id="adaugare-video" class="max-w-md p-2 mx-auto mt-8 bg-white rounded-md shadow-md">
         <button @click="open = !open">
         <div class="flex justify-between">
