...
<main class="container py-20 mx-auto">
    ...
    <div class="relative group">
        ...
        <a href="{{ route('login.google') }}"
           class="relative flex items-center justify-center px-8 py-4 text-white transition-all duration-300 bg-black/80 backdrop-blur-sm rounded-lg group-hover:bg-black/90">
            <!-- Icon Google -->
