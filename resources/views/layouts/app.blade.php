...
<body class="flex flex-col min-h-screen font-sans antialiased bg-gray-100">
    <div class="flex-grow">
        ...
        <!-- Page Content -->
        <main class="container flex-grow px-4 py-4 mx-auto ">
            {{ $slot }}
        </main>
    </div>
            ...
            <div class="flex flex-wrap justify-between">
                ...
                <div class="w-full mb-6 md:w-1/3 md:mb-0">
                    ...
                    <ul class="text-gray-400">
                        <li><a href="{{ route('privacy-policy') }}" class="transition duration-300 hover:text-white">Politica de confidențialitate</a></li>
                        <li><a href="{{ route('terms-of-service') }}" class="transition duration-300 hover:text-white">Termeni și Condiții</a></li>
                        <li><a href="{{ route('contact') }}" class="transition duration-300 hover:text-white">Contact</a></li>
                        <li><a href="{{ route('blog.index') }}" class="transition duration-300 hover:text-white">Blog</a></li>
                    </ul>
                </div>
                <div class="w-full md:w-1/3">
                    <h3 class="mb-3 text-xl font-bold">Mă găsesti și aici:</h3>
                    <div class="flex space-x-4">
                        <a href="https://instagram.com/clickmusic1" target="_blank" rel="noopener noreferrer" class="text-gray-400 transition duration-300 hover:text-white">
                        ...
                        <a href="https://www.facebook.com/clickmusicromania" target="_blank" rel="noopener noreferrer" class="text-gray-400 transition duration-300 hover:text-white">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                                <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951"/>
                            </svg>
                        </a>
                        <a href="https://open.spotify.com/artist/0rbyxJSUfSXjmeW652c41O?si=4I3hPlSITruYO69znEmXFA&nd=1&dlsi=cf9e5847f277482e" target="_blank" rel="noopener noreferrer" class="text-gray-400 transition duration-300 hover:text-white">
                        ...
                        <a href="https://youtube.com/clickmusicromania" target="_blank" rel="noopener noreferrer" class="text-gray-400 transition duration-300 hover:text-white">
