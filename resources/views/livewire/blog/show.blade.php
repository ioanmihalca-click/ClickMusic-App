            ...
            <header class="relative">
                ...
                <div class="p-4 sm:p-6 md:p-8 lg:p-12">
                    ...
                    <div class="pt-8 mt-12 border-t border-white/10">
                        <h3 class="mb-6 text-lg font-semibold text-white">Împărtășește această poveste</h3>
                        <div class="flex flex-wrap gap-4">
                            <!-- Facebook -->
                            <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(route('blog.show', $post->slug)) }}"
                                target="_blank" rel="noopener noreferrer"
                                class="inline-flex items-center px-6 py-3 text-sm font-medium text-white transition-colors duration-300 bg-blue-600 shadow-lg hover:bg-blue-700 rounded-xl shadow-blue-500/25">
                            ...
                            <a href="https://www.linkedin.com/sharing/share-offsite/?url={{ urlencode(route('blog.show', $post->slug)) }}"
                                target="_blank" rel="noopener noreferrer"
                                class="inline-flex items-center px-6 py-3 text-sm font-medium text-white transition-colors duration-300 bg-blue-700 shadow-lg hover:bg-blue-800 rounded-xl shadow-blue-500/25">
                                <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
                                    <path
                            ...
                            <a href="https://api.whatsapp.com/send?text={{ urlencode($post->title) }} - {{ urlencode(route('blog.show', $post->slug)) }}"
                                target="_blank" rel="noopener noreferrer"
                                class="inline-flex items-center px-6 py-3 text-sm font-medium text-white transition-colors duration-300 bg-green-600 shadow-lg hover:bg-green-700 rounded-xl shadow-green-500/25">
                                <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
                                    <path
