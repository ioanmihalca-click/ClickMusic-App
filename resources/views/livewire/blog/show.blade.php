...
<div class="relative py-12">
    ...
    <div class="relative article-container">
        <article class="glass-effect rounded-3xl overflow-hidden">
            <!-- Article header -->
            <header class="relative">
                        ...
                        <div class="absolute bottom-8 left-8 right-8">
                            <div class="flex items-center mb-4">
                                <time datetime="{{ $post->published_at->toDateString() }}"
                                    class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-black/50 backdrop-blur-md rounded-full border border-white/20">
                                ...
                                <span
                                    class="ml-4 inline-flex items-center px-4 py-2 text-sm font-medium text-blue-400 bg-blue-500/20 backdrop-blur-md rounded-full border border-blue-500/30">
                                    <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="p-8 md:p-12">
                    ...
                    <div class="mt-12 pt-8 border-t border-white/10">
                        <h3 class="text-lg font-semibold text-white mb-6">Împărtășește această poveste</h3>
                        <div class="flex flex-wrap gap-4">
                            <!-- Facebook -->
                            <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(route('blog.show', $post->slug)) }}"
                                target="_blank" rel="noopener noreferrer"
                                class="inline-flex items-center px-6 py-3 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-xl transition-colors duration-300 shadow-lg shadow-blue-500/25">
                            ...
                            <a href="https://www.linkedin.com/sharing/share-offsite/?url={{ urlencode(route('blog.show', $post->slug)) }}"
                                target="_blank" rel="noopener noreferrer"
                                class="inline-flex items-center px-6 py-3 text-sm font-medium text-white bg-blue-700 hover:bg-blue-800 rounded-xl transition-colors duration-300 shadow-lg shadow-blue-500/25">
                                <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
                                    <path
                            ...
                            <a href="https://api.whatsapp.com/send?text={{ urlencode($post->title) }} - {{ urlencode(route('blog.show', $post->slug)) }}"
                                target="_blank" rel="noopener noreferrer"
                                class="inline-flex items-center px-6 py-3 text-sm font-medium text-white bg-green-600 hover:bg-green-700 rounded-xl transition-colors duration-300 shadow-lg shadow-green-500/25">
                                <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
                                    <path
                        ...
                        <div class="mt-12 pt-8 border-t border-white/10">
                            ...
                            <div class="mb-12">
                                <a href="{{ route('blog.index') }}"
                                    class="inline-flex items-center px-6 py-3 text-sm font-medium text-white bg-gradient-to-r from-slate-600 to-slate-700 rounded-xl hover:from-slate-700 hover:to-slate-800 transition-all duration-300 transform hover:scale-105 shadow-lg shadow-slate-500/25">
                            ...
                            <!-- Newsletter signup -->
                            <div
                                class="bg-gradient-to-br from-blue-600/20 to-purple-600/20 rounded-2xl p-8 border border-blue-500/20">
                                @if (session('success'))
                                    <div
                                        class="p-4 mb-6 text-green-400 rounded-lg bg-green-900/50 border border-green-500/30">
                                        {{ session('success') }}
                                    </div>
                                @endif
                                ...
                                @if ($errors->any())
                                    <div
                                        class="p-4 mb-6 text-red-400 rounded-lg bg-red-900/50 border border-red-500/30">
                                    ...
                                    <div class="space-y-4">
                                        <div>
                                            ...
                                            <input id="name" name="name" type="text" required
                                                class="w-full px-4 py-3 text-white placeholder-gray-400 bg-slate-800/80 border border-slate-600 rounded-xl focus:border-blue-500 focus:ring-2 focus:ring-blue-500/50 transition-colors"
                                        ...
                                        <button type="submit"
                                            class="w-full px-6 py-3 text-sm font-semibold text-white bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 shadow-lg shadow-blue-500/25">
                                            🚀 Abonează-te acum
                                        </button>
                                    </div>
        ...
        @if ($recommendedPosts->isNotEmpty())
            <section class="mt-16">
                <div class="text-center mb-12">
                    ...
                    <div class="w-16 h-1 mx-auto mt-6 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full"></div>
                </div>
                        ...
                        <article class="blog-grid-item group">
                            <div class="glass-effect rounded-2xl overflow-hidden h-full">
                                <a href="{{ route('blog.show', $post->slug) }}" class="block h-full">
                                    ...
                                    <div class="p-6">
                                        <h3
                                            class="text-lg font-bold text-white mb-3 line-clamp-2 group-hover:text-blue-400 transition-colors duration-300">
                                            {{ $post->title }}
                                        </h3>
