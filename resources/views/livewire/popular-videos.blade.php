...
<a href="{{ route('videos.show', $video) }}">
    @foreach ($popularVideos as $video)
            ...
            <h3 class="pl-1 mb-1 text-base font-semibold">{{ $video->title }}</h3>
              <p class="pl-1 text-sm text-gray-600">Vezi mai mult... <svg xmlns="http://www.w3.org/2000/svg" class="inline-block w-4 h-4 ml-1 text-blue-500" viewBox="0 0 20 20" fill="currentColor">
