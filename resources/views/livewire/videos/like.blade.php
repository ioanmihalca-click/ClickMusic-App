<div x-data="{ isLiked: @entangle('isLiked') }">
    <button
        class="flex items-center px-2 py-1 text-xs transition-colors duration-300 focus:outline-none"
        :class="isLiked ? 'text-red-600 hover:text-red-700' : 'text-gray-600 hover:text-gray-700'"
        wire:click="toggleLike"
        wire:loading.attr="disabled"
    >
        <svg xmlns="http://www.w3.org/2000/svg" 
             class="inline-block w-6 h-6 mr-1 transition-colors duration-300" 
