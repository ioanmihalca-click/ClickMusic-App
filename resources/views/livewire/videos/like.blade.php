   <button class="px-2 py-1 text-xs text-gray-600 hover:text-red-600 focus:outline-none" wire:click.prevent="like">
                        <svg xmlns="http://www.w3.org/2000/svg" class="inline-block w-6 h-6 mr-1 text-red-600"
