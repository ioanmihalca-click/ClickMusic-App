<div class="w-full mx-auto" x-data="{ isLoading: false }" x-on:livewire:loading.window="isLoading = true"
    ...
    <div class="relative mb-6">
        <div class="flex">
            ...
            <div x-show="isLoading" class="absolute transform -translate-y-1/2 right-4 top-1/2">
                <svg class="w-5 h-5 text-gray-400 animate-spin" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 24 24">
            ...
            @if ($searchResults->count() > 0)
                <div class="grid grid-cols-1 gap-6 mt-6 mb-8 sm:grid-cols-2 lg:grid-cols-3">
                    @foreach ($searchResults as $video)
                        <div
                            class="overflow-hidden transition-all duration-300 bg-gray-800/50 backdrop-blur border border-gray-700/30 rounded-xl group hover:scale-[1.02]">
