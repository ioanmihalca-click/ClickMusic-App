<div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
    @foreach ($recentVideos as $video)
        <div class="relative group">
            ...
            <!-- Card-ul principal -->
            <div class="relative flex flex-col overflow-hidden border border-gray-800 bg-gray-900/90 backdrop-blur-sm rounded-xl">
                ...
                <div class="relative flex flex-col flex-grow">
                    ...
                    <div class="absolute inset-0 z-10 transition-opacity duration-300 bg-black/50 group-hover:opacity-0"></div>
                    
                    <!-- Conținutul efectiv -->
                    <div class="relative z-20 p-5 space-y-3">
                        <!-- Titlu cu trunchiere -->
                        <h3 class="text-lg font-bold leading-tight tracking-wide text-white transition-colors duration-300 line-clamp-1 group-hover:text-blue-400">
                            {{ $video->title }}
                        </h3>
                        ...
                        <a href="{{ route('videos.show', $video) }}" 
                           class="inline-flex items-center text-sm font-medium text-blue-400 transition-all duration-300 group-hover:text-blue-300">
                            <span class="relative after:absolute after:bottom-0 after:left-0 after:h-[2px] after:w-0 after:bg-blue-300 after:transition-all after:duration-300 group-hover:after:w-full">
                                Vezi mai mult
                            </span>
