...
new class extends Component {
    public string $name = '';
    public string $email = '';
    public bool $forum_notifications = true;
    ...
    public function mount(): void
    {
        ...
        $this->forum_notifications = $user->forum_notifications ?? true;
        $this->newsletter_consent = $user->newsletter_consent ?? false;
    }
    ...
    public function sendVerification(): void
    {
        ...
        if ($user->hasVerifiedEmail()) {
            $this->redirectIntended(default: route('videoclipuri', absolute: false));
            ...
            <div class="flex items-start">
                ...
                <div class="ml-3 text-sm">
                    <label for="forum_notifications"
                        class="text-white">{{ __('Primește notificări prin email pentru răspunsuri noi în forumul de discuții') }}</label>
                    <p class="text-gray-400">
                        {{ __('Vei primi email-uri când cineva răspunde în discuțiile tale sau în discuțiile la care participi.') }}
                    </p>
                </div>
            </div>
