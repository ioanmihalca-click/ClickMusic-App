...
<body class="font-sans antialiased bg-gradient-to-t from-blue-500 to-gray-100">
    ...
    <main class="container px-4 py-12 mx-auto">
        <div class="max-w-3xl mx-auto">
            <!-- Hero Section -->
            <section
                class="mb-16 overflow-hidden transition-all duration-300 transform bg-white shadow-lg rounded-3xl hover:shadow-2xl">
                <div class="relative p-8 md:p-12">
                    ...
                    <div class="relative z-10 text-center">
                        ...
                        <h2 class="mb-6 text-xl text-gray-700 md:text-2xl">Bine ai venit pe platforma de streaming Click
                            Music</h2>
            ...
            <section class="mb-16 overflow-hidden transition-all duration-300 transform shadow-lg bg-gradient-to-t from-blue-300 to-white rounded-3xl hover:shadow-2xl">
                ...
                <div class="p-4">
                    ...
                    <div class="relative px-4 mb-8 ">
                        <div class="overflow-hidden rounded-lg shadow-lg" style="position:relative;padding-top:56.25%;">
                            <iframe src="https://www.youtube.com/embed/8WPtQ5P-PVU?si=bdpOHOevyPob-nxH" loading="lazy"
