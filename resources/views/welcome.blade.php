    ...
    <div class="max-w-2xl px-4 mx-auto mt-20 text-center">
        ...
        <div class="flex justify-center">
            <a href="{{ route('login.google') }}"
                class="flex items-center justify-center px-6 py-3 text-white transition duration-300 ease-in-out transform bg-blue-500 border border-blue-600 rounded-full shadow-md hover:bg-blue-600 hover:-translate-y-1">
