...
<head>
    ...
    <!-- Meta Tags -->
    <meta name="description" content="Descoperă albumele artistului Click - muzică hip-hop, soul și reggae autentică din Baia Mare, România. Streaming și achiziție de albume disponibile.">
    ...
    <meta property="og:description" content="Explorează colecția de albume a artistului Click - hip-hop, soul și reggae direct din inima României.">
...
<body class="font-sans antialiased bg-gray-100">
    <header class="bg-white shadow">
        <div class="container flex items-center justify-between px-4 py-6 mx-auto">
            ...
            <nav>
<a href="https://clickmusic.ro" class="px-3 py-2 text-gray-600 hover:text-gray-900" target="_blank" rel="noopener noreferrer">Acasă</a>
<a href="https://clickmusic.ro/magazin" class="px-3 py-2 text-gray-600 hover:text-gray-900" target="_blank" rel="noopener noreferrer">Albume</a>
<a href="https://clickmusic.ro/blog" class="px-3 py-2 text-gray-600 hover:text-gray-900" target="_blank" rel="noopener noreferrer">Blog</a>
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex flex-col md:flex-row">
                        ...
                        <div class="mt-4 md:w-2/3 md:pl-8 md:mt-0">
                            ...
                            <p class="mb-4">An lansare: {{\Carbon\Carbon::parse($album->data_lansare)->format('Y')}}</p>
...
<!-- Share buttons -->
                        <div class="mt-4">
                            ...
                            <div class="flex mt-4 space-x-4 share-buttons"> 
                                <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(route('album.show', $album->slug)) }}" target="_blank" rel="noopener noreferrer">
                                ...
                                <a href="https://www.linkedin.com/sharing/share-offsite/?url={{ urlencode(route('album.show', $album->slug)) }}" target="_blank" rel="noopener noreferrer">
                                ...
                                <a href="https://api.whatsapp.com/send?text={{ urlencode($album->titlu) }} - {{ urlencode(route('album.show', $album->slug)) }}" target="_blank" rel="noopener noreferrer">
