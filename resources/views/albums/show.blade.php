...
<body class="font-sans antialiased bg-gray-100">
    <header class="bg-white shadow">
        <div class="container flex items-center justify-between px-4 py-6 mx-auto">
            ...
            <nav>
                <a href="https://clickmusic.ro" class="px-3 py-2 text-gray-600 hover:text-gray-900" target="_blank"
                    rel="noopener noreferrer">Acasă</a>
                <a href="https://clickmusic.ro/magazin" class="px-3 py-2 text-gray-600 hover:text-gray-900"
                    target="_blank" rel="noopener noreferrer">Albume</a>
                <a href="https://clickmusic.ro/blog" class="px-3 py-2 text-gray-600 hover:text-gray-900" target="_blank"
                            ...
                            <div class="mt-4">
                                ...
                                <div class="flex mt-4 space-x-4 share-buttons">
                                    ...
                                    <a href="https://api.whatsapp.com/send?text={{ urlencode($album->titlu) }} - {{ urlencode(route('album.show', $album->slug)) }}"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                                            fill="currentColor"
                                            class="text-blue-500 hover:text-blue-600 bi bi-whatsapp"
                                            viewBox="0 0 16 16">
                                            <path
