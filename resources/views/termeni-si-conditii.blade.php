...
<body class="text-gray-800 bg-gray-100">
    <div class="container p-8 mx-auto">
        <div class="p-6 bg-white rounded-lg shadow-lg">
            ...
            <h2 class="mb-2 text-2xl font-semibold">3. Drepturile de Autor</h2>
            ...
            <h2 class="mb-2 text-2xl font-semibold">4. Limitări</h2>
            ...
            <h2 class="mb-2 text-2xl font-semibold">5. Modificări ale Termenilor și Condițiilor</h2>
            ...
            <h2 class="mb-2 text-2xl font-semibold">6. Contact</h2>
            <p class="mb-4">Dacă aveți întrebări sau nelămuriri cu privire la acești termeni și condiții, vă rugăm să ne contactați la adresa <a href="mailto:contact@clickmusic.com" class="text-blue-500">clickmusicro@gmail.com</a>.</p>
        </div>
    </div>
</body>
</html>
